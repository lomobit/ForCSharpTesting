...
4. Условная логика (CASE WHEN)
	...
	#1907 — Count Salary Categories (Medium) — создание категорий «на лету»
	#1193 — Monthly Transactions I (Medium)

5. Подзапросы и CTE (WITH)
	#185 — Department Top Three Salaries (Hard, но полезная для Medium уровня)
